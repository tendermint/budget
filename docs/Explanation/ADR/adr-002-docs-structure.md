...
- Use GitHub as primary content management [https://github.com/tendermint/budget](https://github.com/tendermint/budget)
...
The specific implementation for Budget module SHOULD BE as per the following tree structure.
...
The `use-cases` folder describes the Budget module use cases. Ideally, use cases are written in behavior-driven development (BDD) format. Use case content should be dry in nature and avoid explanations that should be covered in the explanation documentation.
