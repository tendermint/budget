...
1. Every ADR proposal SHOULD start with a [new GitHub issue](https://github.com/tendermint/budget/issues/new/choose) or be a result of existing Issues. The Issue must contain a brief proposal summary.
